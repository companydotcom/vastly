...
const validateForPercentage = (resp) =>
  (resp >= 0 && resp <= 100 && Number.isInteger(resp)) ||
  "Please enter a whole number between 0 and 100 (inclusive)"
...
const getWhatThrottles = {
  ...
  name: "whichThrottle",
  message:
    "What throttle intervals does your service need to respect if any? (Select as many as apply)",
  default: [],
