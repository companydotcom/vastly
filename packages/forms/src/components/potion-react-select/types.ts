...
import { CSSWithMultiValues, SystemStyleObject } from "@companydotcom/potion"
...
export type PotionStylesConfig<
  Option = unknown,
...
declare module "react-select/dist/declarations/src/Select" {
  export interface Props<Option, IsMulti extends boolean, Group extends GroupBase<Option>> {
     ...
     */
    potionStyles?: PotionStylesConfig<Option, IsMulti, Group>
  }
}
