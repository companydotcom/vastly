...
export const PasswordInput = forwardRef<PasswordInputProps, "div">((props, ref) => {
  const { viewIcon, viewOffIcon, autoComplete, w, width, size, variant, ...inputProps } = props
  ...
  return (
    <InputGroup {...groupProps}>
      ...
      <InputRightButton onClick={handleClick} aria-label={label} variant="ghost">
        {icon}
      </InputRightButton>
    </InputGroup>
  )
