    ...
    <StylesProvider value={styles}>
      <StepperProvider value={context}>
        <chakra.div
          ...
          {...containerProps}
          className={cx("wave-ui-labeledStepper", props.className)}
        >
          {children}
        </chakra.div>
      </StepperProvider>
  ...
  return (
    <>
      <chakra.div
        __css={stepperStyles}
        {...rest}
        className={cx("wave-ui-labeledStepper__steps", props.className)}
      >
        {elements}
      </chakra.div>
      {content}
...
export const LabeledStepperCompleted: React.FC<HTMLChakraProps<"div">> = (props) => {
  ...
  return (
    <chakra.div
      ...
      {...props}
      className={cx("wave-ui-labeledStepper__completed", props.className)}
    />
  );
};
...
export const LabeledStepperContent = (props: LabeledStepperContentProps) => {
  ...
  return (
    <chakra.div
      ...
      {...rest}
      className={cx("wave-ui-labeledStepper__content", props.className)}
    >
...
export const LabeledStepperStep = (props: LabeledStepperStepProps) => {
  ...
  return (
    <chakra.div
      ...
      className={cx("wave-ui-labeledStepper__step", props.className)}
    >
...
export const LabeledStepperSeparator = (props: LabeledStepperSeparatorProps) => {
  ...
  return (
    <chakra.div
      ...
      className={cx("wave-ui-labeledStepper__separator", props.className)}
...
export const LabeledStepperStepTitle: React.FC<HTMLChakraProps<"p">> = (props) => {
  ...
  return (
    <chakra.p
      {...props}
      __css={styles.title}
      className={cx("wave-ui-labeledStepper__title", props.className)}
    />
  );
};
